<%-- 
    Document   : C.DNI
    Created on : 27 jun. 2023, 11:43:49
    Author     : Admin
--%>
            ...
            <div class="content-wrapper">
                ...
                <div class="box">    
                    ...
                    <div class="box-body">
                        ...
                        <form class="form-horizontal" action="srvReniec?accion=generar_consulta" method="post">
                            <div class="box-body">
...
<div class="col-md-10 input-group">
    ...
    <input maxlength="8" type="text" inputmode="numeric" class="form-control" id="txtDNI" name="txtDNI" oninput="validateInput()" required>
</div>
    ...
    function validateInput() {
        ...
        if (/^\d{8}$/.test(inputValue)) {
            ...
            submitButton.disabled = true;
                                ...
                                <div class="row">
                                    <button type="submit" id="submitBtn" class="btn btn-primary ">Buscar</button>
                                </div>
                            </div>
                        </form>
                    </div>
